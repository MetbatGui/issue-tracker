...
class DualIncreaseXmlParser(BaseXmlParser):
    ...
    @classmethod
    def parse(cls, xml_source, rcept_no: Optional[str] = None, parent_rcp_no: Optional[str] = None, source_filename: Optional[str] = None) -> Tuple[Optional[CapitalIncreaseDecision], Optional[BonusSharesDecision]]:
